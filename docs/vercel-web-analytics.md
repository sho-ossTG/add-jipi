...
### For Next.js, Next.js App Router, SvelteKit, Remix, Create React App, Nuxt, Vue, Astro, and Other Frameworks
...
#### Astro Adapter Configuration (Legacy)
...
**TypeScript/JavaScript** (`index.html`):
```html
<script>
